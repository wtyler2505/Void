    ...
    <aside role="navigation" aria-label="Note sidebar" className={`w-full h-full flex flex-col ${isDark ? 'bg-[#0a0a0a]' : 'bg-white'} z-10`}>
      ...
      <div className={`p-4 border-b ${isDark ? 'border-[#1a1a1a]' : 'border-gray-200'}`}>
        ...
        <div className="grid grid-cols-8 gap-1">
            <div className="relative flex col-span-2" ref={templateRef}>
                <button onClick={onCreateNote} aria-label="Create new note" className={`flex-1 flex items-center justify-center ${isDark ? 'bg-[#1a1a1a] hover:bg-[#222] border-[#333] text-white' : 'bg-gray-100 hover:bg-gray-200 border-gray-300 text-gray-800'} py-2 border border-r-0 transition-all hover:border-[#00ff9d] text-sm group`} title="New Note (Ctrl+N)"><ICONS.Plus /></button>
                <button onClick={() => setIsTemplateOpen(!isTemplateOpen)} aria-label="New from template" aria-expanded={isTemplateOpen} className={`flex items-center justify-center px-1 ${isDark ? 'bg-[#1a1a1a] hover:bg-[#222] border-[#333]' : 'bg-gray-100 hover:bg-gray-200 border-gray-300'} text-gray-500 py-2 border transition-all hover:border-[#00ff9d] hover:text-[#00ff9d] text-[10px] ${isTemplateOpen ? 'border-[#00ff9d] text-[#00ff9d]' : ''}`} title="New from Template">▼</button>
                {isTemplateOpen && (
            ...
            <button
              ...
              className={`flex items-center justify-center py-2 ${isDark ? 'bg-[#1a1a1a] hover:bg-[#222] border-[#333]' : 'bg-gray-100 hover:bg-gray-200 border-gray-300'} border transition-all hover:border-[#00ff9d] text-gray-400 hover:text-[#00ff9d]`}
            ...
            <button
              ...
              className={`flex items-center justify-center py-2 border transition-all ${isMultiSelectMode ? 'bg-[#002b1f] border-[#00ff9d] text-[#00ff9d]' : `${isDark ? 'bg-[#1a1a1a] hover:bg-[#222] border-[#333]' : 'bg-gray-100 hover:bg-gray-200 border-gray-300'} text-gray-400 hover:text-[#00ff9d] hover:border-[#00ff9d]`}`}
              title="Multi-select"
